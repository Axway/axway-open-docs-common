...
Clear navigation is highly usable by helping the user to navigate through your website. Think about the main topics the user will be searching, and then specific questions or documents they will be looking for as child topics.

Organize similar content types under the same menu. For example, you can place all Installation and Upgrade manuals under the **Installation instructions** menu. This makes it easier to find all information related to installation in one place.

Avoid using more than three menu levels because it can make the menu confusing to navigate.
...
* Create clear navigation for search engines to understand what content is important
...
* [Getting stared with Docker](https://docs.docker.com/get-started/#start-the-tutorial)
...
* Know that the first 3-5 words of every paragraph are the most important
* Use bullet lists
...
* Do not paste the actual URL in the page as this does not read well, especially for screen readers (accessibility)
...
Not all analyses or results need a table or image. Some simple results are best stated in a short paragraph.
